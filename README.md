...
[![Publish to npm](https://img.shields.io/github/actions/workflow/status/vrepsaj/chatto.ts/.github%2Fworkflows%2Fpublish.yml)](https://github.com/vrepsaj/chatto.ts)
...
Tested against `v0.4.14` of Chatto.
